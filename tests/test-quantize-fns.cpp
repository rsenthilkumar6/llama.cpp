...
constexpr float MAX_QUANTIZATION_TOTAL_ERROR_TBQ3 = 0.16f;
constexpr float MAX_QUANTIZATION_TOTAL_ERROR_TBQ4 = 0.10f;
...
constexpr float MAX_DOT_PRODUCT_ERROR_TBQ3 = 1.2f;
constexpr float MAX_DOT_PRODUCT_ERROR_TBQ4 = 1.2f;
